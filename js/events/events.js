...
const EVENTS = [
        ...
        choices: [
            ...
            },
            {
                ...
                effects: [
                    ...
                    { type: 'flag', flag: 'quest_shelter_found', value: true } // Выполняем задачу квеста
                ]
            },
            {
    ...
    },
    {
        ...
        description: 'Вдалеке вы замечаете металлические конструкции, частично погребенные в земле. Это обломки вашего корабля!',
        conditions: (gameState) => true,
        choices: [
            {
                text: 'Подойти ближе',
                outcome: 'Вы подходите к обломкам. Внутри еще много полезных ресурсов и оборудования.',
                effects: [
                    { type: 'inventory', item: 'Электроника', value: 2 },
                    { type: 'inventory', item: 'Сплав металла', value: 5 },
                    { type: 'flag', flag: 'quest_crash_site_found', value: true } // Выполняем задачу квеста
                ]
            },
            {
                text: 'Осмотреть снаружи',
                outcome: 'Вы осматриваете обломки снаружи. Видны повреждения, но конструкция еще прочная.',
                effects: [
                    { type: 'flag', flag: 'quest_crash_site_found', value: true } // Выполняем задачу квеста
                ]
            },
            {
                ...
                outcome: 'Вы решаете вернуться к этим обломкам позже, когда будете лучше подготовлены.',
                effects: []
            }
        ]
    }
